...
;(function($){
	...
	$.fn.simpletooltip = function(settings) {
		...
		this.each(function () {
            ...
            if (options.click) {
                $(this).bind("click", {"options": options, "target": this, "tipTimeOut": tipTimeOut}, openTooltip);
            }
			
			if (!options.click || options.clickAndHover) {
				$(this)
	...
	function openTooltip(e){
		...
		if (e.data.tipTimeOut) {
		    window.clearTimeout(e.data.tipTimeOut);
		}
		...
		if (opts.showEffect && ( opts.showEffect.match(/^fadeIn|slideDown|show$/) ) ) {
			$tooltip.bind("show", function(){
				$tooltip[opts.showEffect](opts.showEffectDuration);
		...
		if (opts.hideEffect && ( opts.hideEffect.match(/^fadeOut|slideUp|hide$/) ) ) {
			$tooltip.bind("hide", function(){
				...
				$tooltip[opts.hideEffect](opts.hideEffectDuration);
			});
		}
		else {
			$tooltip.bind("hide", function(){
