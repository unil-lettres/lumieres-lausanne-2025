...
urlpatterns = [
    ...
    path(
        "biblio/documents/change_list/<int:doc_id>/",
        bibliography_documentfile_change_list,
        name="bibliography-documentfile-change-list",
    ),
    re_path(
        r"^biblio/(?P<doc_id>\d+)/document/(?P<docfile_id>\d+)/add/$",
        bibliography_documentfile_add,
        name="bibliography-documentfile-add",
    ),
    re_path(
        r"^biblio/(?P<doc_id>\d+)/document/(?P<docfile_id>\d+)/remove/$",
        bibliography_documentfile_remove,
    ...
    re_path(
        r"^documents/download/(?P<documentfile_key>[a-zA-Z0-9_-]+)/$",
        serve_documentfile,
        {"attachment": True},
        name="download-file",
    ),
    ...
    path(
        "document/f_create/<int:docfile_id>/done/",
        documentfile_frame_create,
        {"create_done": True},
        name="docfile-frame-create-done",
    ),
    re_path(r"^document/f_edit/(?P<docfile_id>\d+)/$", documentfile_frame_edit, name="docfile-frame-edit"),
    path(
        "document/f_edit/<int:docfile_id>/done/",
        documentfile_frame_edit,
        {"edit_done": True},
    ...
    path(
        "collection/_list/json/", views_collections.get_user_list, {"format": "json"}, name="collection-user-list-json"
    ),
    path(
        "collection/_list/", views_collections.get_user_list, {"format": "select"}, name="collection-user-list-select"
    ),
    ...
    re_path(
        r"^collection/_display_short/(?P<coll_id>\d+)/$", views_collections.short_info, name="collection-shortinfo"
    ),
