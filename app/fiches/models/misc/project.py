...
class Project(models.Model):
    ...
    short_desc = models.CharField(
        ...
        blank=True,
        help_text=_(
            "Texte utilisé dans la liste des projets. <strong>250 signes maximum.</strong> Si le champ est vide, le texte de description normal sera utilisé, tronqué à 250 signes"
        ),
    )
    image = models.ImageField(verbose_name=_("Vignette"), upload_to="user_uploads/%Y/%m", blank=True)
    ...
    access_groups = models.ManyToManyField(
        UserGroup, verbose_name=_("Groupes"), related_name="group_projects", blank=True
    )
